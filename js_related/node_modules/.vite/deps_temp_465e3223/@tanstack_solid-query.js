import {
  isServer
} from "./chunk-5CNWEJP6.js";
import {
  createStore,
  reconcile,
  unwrap
} from "./chunk-M25QXO3G.js";
import {
  batch,
  createComponent,
  createComputed,
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/subscribable.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/utils.js
var isServer2 = typeof window === "undefined" || "Deno" in globalThis;
function noop() {
  return void 0;
}
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/focusManager.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/onlineManager.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/retryer.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/notifyManager.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/removable.js
var _gcTimeout, _a3;
var Removable = (_a3 = class {
  ...
  updateGcTime(newGcTime) {
    this.gcTime = Math.max(
      this.gcTime || 0,
      newGcTime ?? (isServer2 ? Infinity : 5 * 60 * 1e3)
    );
  }
  clearGcTimeout() {
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/query.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/queryCache.js
var _queries, _a5;
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/mutation.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/mutationCache.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/infiniteQueryBehavior.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/queryClient.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/queryObserver.js
...
var QueryObserver = (_a9 = class extends Subscribable {
  ...
  if (isServer2 || __privateGet(this, _currentResult).isStale || !isValidTimeout(staleTime)) {
    return;
  }
  ...
  if (isServer2 || resolveEnabled(this.options.enabled, __privateGet(this, _currentQuery)) === false || !isValidTimeout(__privateGet(this, _currentRefetchInterval)) || __privateGet(this, _currentRefetchInterval) === 0) {
    return;
  }
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/queriesObserver.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/infiniteQueryObserver.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/mutationObserver.js
...
// ../../../../AppData/Local/Yarn/Berry/cache/@tanstack-query-core-npm-5.51.9-6ef6539693-10c0.zip/node_modules/@tanstack/query-core/build/modern/hydration.js
...
// .yarn/__virtual__/@tanstack-solid-query-virtual-f9676e1f0d/5/AppData/Local/Yarn/Berry/cache/@tanstack-solid-query-npm-5.51.9-2e8e3ce6cf-10c0.zip/node_modules/@tanstack/solid-query/build/dev.js
...
function createBaseQuery(options, Observer, queryClient) {
  const client = createMemo(() => useQueryClient(queryClient == null ? void 0 : queryClient()));
  ...
  function createDeepSignal() {
    return [
      ...
      (v) => {
        ...
        if (v == null ? void 0 : v.hydrationData) {
    ...
    get(target, prop) {
      ...
      if (prop === "data") {
        if (state.data !== void 0) {
          return (_a12 = queryResource.latest) == null ? void 0 : _a12.data;
        }
        return (_b = queryResource()) == null ? void 0 : _b.data;
      }
...
function useIsFetching(filters, queryClient) {
  ...
  const [fetches, setFetches] = createSignal(client().isFetching(filters == null ? void 0 : filters()));
  const unsubscribe = queryCache().subscribe(() => {
    setFetches(client().isFetching(filters == null ? void 0 : filters()));
  });
...
function useIsMutating(filters, queryClient) {
  ...
  const [mutations, setMutations] = createSignal(
    client().isMutating(filters == null ? void 0 : filters())
  );
  const unsubscribe = mutationCache().subscribe((_result2) => {
    setMutations(client().isMutating(filters == null ? void 0 : filters()));
  });
  onCleanup(unsubscribe);
  return mutations;
}
...
//# sourceMappingURL=@tanstack_solid-query.js.map
